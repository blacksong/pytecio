...
#           endif
        ...
        integer(4) function createZones( &
...
#   if defined TECIOMPI
        ! Output partitions
        if (createZones .eq. 0 .and. numPartitions .gt. 0) then
            createZones = TECZNEMAP142(numPartitions, partitionOwners)
        endif
#   endif
